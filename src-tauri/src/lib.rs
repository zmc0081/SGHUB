...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            library::annotations::list_annotations,
            library::annotations::add_annotation,
            library::annotations::delete_annotation,
            library::annotations::update_annotation_color,
